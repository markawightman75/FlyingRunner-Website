...
<tr class="wc-checkout-add-on">
	...
	<td class="wc-checkout-add-on-type">
		<select name="wc-checkout-add-on-type[<?php echo $index; ?>]" class="js-wc-checkout-add-on-type chosen_select" style="width: 100px;">
	...
	<td class="wc-checkout-add-on-attributes">
		<select name="wc-checkout-add-on-attributes[<?php echo $index; ?>][]" class="js-wc-checkout-add-on-attributes chosen_select" multiple="multiple">
	...
	<td class="js-wc-checkout-add-on-draggable">
		<img src="<?php echo $GLOBALS['wc_checkout_add_ons']->get_plugin_url() ?>/assets/images/draggable-handle.png" />
	</td>
</tr>
