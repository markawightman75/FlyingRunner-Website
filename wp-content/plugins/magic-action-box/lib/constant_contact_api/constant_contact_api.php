...
if(!class_exists('CCUtility')) {
	 ...
	 */
	/**
	 * CCUtility Class for all HTTP calls
	 *
	...
	class CCUtility
	{
		public static $saction = 'ACTION_BY_CONTACT';
		public static $sapikey = '';
		public static $susername = '';
		public static $spassword = '';

		/**
		 * Public Function __construct of CCUtility Object
		 *
		...
		{
			$this->setActionBy(self::$saction);
			$this->setApiKey(self::$sapikey);
			$this->setApiPath('https://api.constantcontact.com');
			$this->setLogin(self::$susername);
			$this->setPassword(self::$spassword);
			$this->setRequestLogin($this->getApiKey() . "%" . $this->getLogin() . ":" . $this->getPassword());
		}

		public function ping() {
			return $this->httpGet($this->getApiPath() . '/ws/customers/'. $this->getLogin() .'/');
		}
		...
		//Getters and Setters for the CCUtility class
