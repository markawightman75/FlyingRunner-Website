...
if(!class_exists('MCAPI')) {
	class MCAPI {
		 ...
		 *
		 * @param string $id the list id to connect to. Get by calling lists()
		 * @param string $name a unique name per list for the segment - 50 character maximum length, anything longer will be truncated
		 ...
		 * @param array $merge_vars optional merges for the email (FNAME, LNAME, etc.) (see examples below for handling "blank" arrays). Note that a merge field can only hold up to 255 characters. Also, there are a few "special" keys:
